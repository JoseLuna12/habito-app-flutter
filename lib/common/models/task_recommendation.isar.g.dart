...
part of 'task_recommendation.isar.dart';
...
extension RecommendationQueryWhereSort
  ...
  QueryBuilder<Recommendation, Recommendation, QAfterWhere> anyLocalId() {
...
extension RecommendationQueryWhere
  ...
  QueryBuilder<Recommendation, Recommendation, QAfterWhereClause> nameEqualTo(
      String name) {
    return QueryBuilder.apply(this, (query) {
...
extension RecommendationQuerySortBy
  ...
  QueryBuilder<Recommendation, Recommendation, QAfterSortBy> sortByName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.asc);
    });
  }

  QueryBuilder<Recommendation, Recommendation, QAfterSortBy> sortByNameDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension RecommendationQuerySortThenBy
  ...
  QueryBuilder<Recommendation, Recommendation, QAfterSortBy> thenByLocalId() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Recommendation, Recommendation, QAfterSortBy> thenByName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.asc);
    });
  }

  QueryBuilder<Recommendation, Recommendation, QAfterSortBy> thenByNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.desc);
    });
  }
...
extension RecommendationQueryWhereDistinct
  ...
  QueryBuilder<Recommendation, Recommendation, QDistinct> distinctByName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension RecommendationQueryProperty
  ...
  QueryBuilder<Recommendation, int, QQueryOperations> localIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'localId');
    });
  }

  QueryBuilder<Recommendation, String, QQueryOperations> nameProperty() {
    return QueryBuilder.apply(this, (query) {
